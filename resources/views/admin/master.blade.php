...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset("panel/css/perfect-scrollbar.min.css") }}" />

{{--    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset("panel/css/style.css") }}" />--}}
{{--    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset("tailwind/assets/app-ns14Cm4z.css") }}" />--}}
    ...
    <script defer src="{{ asset("panel/js/sweetalert.min.js") }}"></script>
</head>
...
{{--<script src="{{ asset("panel/js/alpine-persist.min.js") }}"></script>--}}
{{--<script defer src="{{ asset("panel/js/alpine-ui.min.js") }}"></script>--}}
{{--<script defer src="{{ asset("panel/js/alpine-focus.min.js") }}"></script>--}}
{{--<script defer src="{{ asset("panel/js/alpine.min.js") }}"></script>--}}
<script src="{{ asset("panel/js/custom.js") }}"></script>
<script defer src="{{ asset("panel/js/apexcharts.js") }}"></script>
<script>
    // main s
