...
new #[Layout('admin.master'), Title('لیست کاربران')]
class extends Component {
    ...
    #[Validate('nullable|unique:users,phone')]
    public $phone;
    ...
    public function updateRow()
    {
        $this->validate([
            'name' => 'required',
            'email' => 'nullable|unique:users,email,' . $this->editIndex,
            'phone' => 'nullable|unique:users,phone,' . $this->editIndex,
...
?>
<div class="max-w-4xl mx-auto px-6 pt-6 space-y-6" x-data="form">
    <div class="panel">
            ...
            <form class="space-y-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input wire:model="phone" id="phone" type="text" class="form-input">
                        @error('phone')
                        <p class="text-danger mt-1">{{$message}}</p>
                        @enderror
                    </div>
